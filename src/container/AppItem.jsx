  ...
  <div class="carousel__container">
    ...
    <div class="carousel-item">
      ...
      <div class="carousel-item__details">
        <div>             
          <img class="carousel-item__details--img" src="../assets/play-icon.png" alt="Play Icon"></img>
          <img class="carousel-item__details--img" src="../assets/plus-icon.png" alt="Plus Icon"></img>
