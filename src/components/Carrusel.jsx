...
<div className="carousel__container">
      ...
      <div className="carousel-item">
        ...
        <div className="carousel-item__details">
          <div>
          <img className="carousel-item__details--img" src="../assets/static/play-icon.png" alt="Play Icon"></img>
            <img className="carousel-item__details--img" src="../assets/static/plus-icon.png" alt="Plus Icon"></img>
          </div>
